        ...
        .then(result => {
            ...
            this.fields = {};
             ...
             this.dispatchEvent( new ShowToastEvent({
                title : "Success",
                message : "Record has been successfully created  "+ this._topicName,
                variant : "success"
                 }));
            this._topicName = this.template.querySelector('lightning-input[data-name="topic_name"]').value= null;
          //  this._accId = this.template.querySelector('lightning-input[data-name="topic_id"]').value= null; 
